...
public class ControlPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        IR1 = new simulator.Register("IR1", 13, true);
        IR2 = new simulator.Register("IR2", 13, true);
        IR3 = new simulator.Register("IR3", 13, true);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(IR1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(IR2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(IR3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        
    ...
    public void ComputeEffectiveAddress() {
        ...
        if (XF.get().equals("00") & I.get().equals("0")) {
            MAR.set(ADDR.get());
            //MBR.set(MAR.get()); This line is modified by Alex @ Feb 2
            MBR.set(MEMORY.get(MAR.get()));
            
        }
        
        //ALU is a seperate class with OP1, OP2, RES registers. The get(X) and set(X,S) method in ALU class should be 
        //able to take parameter X and S. X is the memory address. S is the new string data.
        else if ((XF.get().equals("01")||XF.get().equals("10")||XF.get().equals("11")) & XF.get().equals("0") )  {  
    ...
    public void STR() {
            ...
            MEMORY.set(SelectRegister().get(), ADDR.get());
    
    }
    
     public void LDA() {
          SelectRegister().set(ADDR.get());
         
    }
    
    public void SMR(){
//        String memoryAddress = MAR.get();
//        MBR.set(MEMORY.get(memoryAddress));
        ALU.OP2.set(MBR.get());
...
//        MBR.set(MEMORY.get(memoryAddress));
    ...
    /**
     * @author Adler
     * TODO: subtracting a bigger num from the Register should return 256+value of the GPR value-immed
     */
    public void SIR(){
    	  ALU.OP2.set(ADDR.get());
    	  ALU.OP1.set(SelectRegister().get());
    ...
    public void LDX(){
        ...
        SelectIndexRegister().set(MBR.get());
    ...
    /**
     * @author Adler
     * @getting the reference of Register Objecet through the decoded register 
     */
    ...
    private simulator.Register IR1;
    private simulator.Register IR2;
    private simulator.Register IR3;
